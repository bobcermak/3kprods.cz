...
const Button: FC<ButtonProps> = ({ isLink = true, link = "#", variant = "primary", isArrow = true, noStyle = false, hover = "", type, onClick, className, children }) => {
  ...
  const combinedClasses: string = !noStyle ? twMerge(baseStyles, variantStyles[variant], className) : `underline hover:${hover} duration-250 ease-in-out`;
