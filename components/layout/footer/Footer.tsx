...
const Footer = () => {
    ...
    return (
        <footer className={`${pathname === "/" ? "mt-25" : ""} relative bg-blue pt-15 laptop:pt-25`}>
            ...
            <section className="relative mx-auto w-xcontent laptop:flex laptop:gap-25 z-10" id="contact-us">
                <div className="basis-[80%]">
                    <div className="max-w-[680px] laptop:max-w-[940px]">
                ...
                <div className="mt-10 laptop:sticky laptop:top-[40%] laptop:mt-0 laptop:self-start h-fit min-[1701px]:static min-[1701px]:self-center">
                    <div className="flex justify-center items-center gap-5 laptop:justify-start cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} >
                        <figure aria-label="3kprods - logo" className="min-w-[100px]"><Image className="img-responsive" src="/images/assets/logo.webp" alt="3kprods - logo" loading="lazy" width={100} height={100}/></figure>
