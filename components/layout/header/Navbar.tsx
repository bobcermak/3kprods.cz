...
const Navbar: FC<NavbarProps> = ({ logo, button, className, href, children }) => {
    ...
    return (
        <nav className={classes}>
            <div className="absolute inset-0 -z-20 rounded-bl-[3rem] rounded-br-[3rem] shadow-primary pointer-events-none transform-gpu" />
            <div className="absolute inset-0 -z-10 rounded-bl-[3rem] rounded-br-[3rem] bg-white/10 backdrop-blur-[200px] pointer-events-none transform-gpu" />
