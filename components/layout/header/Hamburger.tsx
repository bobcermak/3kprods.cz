...
const Hamburger: FC<HamburgerProps> = ({ isClicked }) => {
  ...
  return (
    <Button onClick={() => { setIsOpen(!isOpen); isClicked(!isOpen); }} isLink={false} noStyle={true} className="bg-light-blue/50 rounded-full relative inline-block min-w-[52px] h-[52px] cursor-pointer overflow-hidden laptop:hidden" aria-label="Otevřít menu">
