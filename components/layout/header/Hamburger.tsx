...
const Hamburger: FC<HamburgerProps> = ({ isOpen, onToggle }) => {
  return (
    <Button ariaLabel="Otevřít navigaci" onClick={() => { onToggle(!isOpen); }} isLink={false} noStyle={true} className="bg-light-blue/50 rounded-full relative inline-block min-w-[52px] h-[52px] cursor-pointer overflow-hidden laptop:hidden" aria-label="Otevřít menu">
