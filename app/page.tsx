            ...
            <div className="slaptop:order-1 slaptop:basis-3/5 laptop:basis-1/2">
              ...
              <div className="mt-4">
                ...
                <Ul className="mt-15 slaptop:mt-10 flex flex-col gap-6 slaptop:gap-4 border-b pb-15 slaptop:pb-10 mb-15 slaptop:mb-10 laptop:flex-row laptop:gap-6">
                  <Li className="flex gap-6 items-center laptop:basis-1/2 laptop:grow"><i className="fa-regular fa-user text-[2rem] bg-light-blue text-white px-4 py-3.5 rounded-full"></i><P size="text-sm">Děláme maturáky jinak - bez kompromisů, bez nudy.</P></Li>
                  <Li className="flex gap-6 items-center laptop:basis-1/2 laptop:grow"><i className="fa-solid fa-handshake-angle text-[1.75rem] bg-light-blue text-white px-[12.5px] py-4 rounded-full"></i><P size="text-sm">Každou práci dotáhneme do konce.</P></Li>
                </Ul>
              </div>
              <div>
