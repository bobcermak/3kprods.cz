import { Ul, Li, Navbar, Button, Footer, PageWrapper } from "@/components";
...
export default function RootLayout({
  ...
  return (
    ...
    <body>
      ...
      <header>
        <Navbar logo="/images/assets/logo.webp" button="Jdeme na to" className="fixed z-50 left-0 right-0 laptop:left-[50%] laptop:translate-x-[-50%] flex items-center justify-between px-3 py-1 rounded-bl-[3rem] rounded-br-[3rem] bg-white/10 backdrop-blur-[200px] shadow-primary laptop:w-container" href="tel:+420722145257">
