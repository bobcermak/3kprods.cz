  ...
  return (
    <html lang="cs">
      ...
      <body>
        ...
        <header>
          <Navbar logo="/images/assets/logo.webp" button="Jdeme na to" className="fixed z-50 left-0 right-0 laptop:left-[50%] laptop:translate-x-[-50%] flex items-center justify-between px-3 py-1 rounded-bl-[3rem] rounded-br-[3rem] bg-white/10 backdrop-blur-[200px] laptop:w-container shadow-primary transform-gpu backface-hidden" href="tel:+420722145257">
